@extends('client.inc.app', ['class' => 'off-canvas-sidebar', 'activePage' => '', 'title' => __('Esqueci minha senha')])
      ...
      <form class="form" method="POST" action="{{ route('password.request') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg">{{ __('Resetar senha') }}</button>
          </div>
        </div>
      </form>
    </div>
